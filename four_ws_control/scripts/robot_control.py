...
class Commander(Node):
    ...
    def __init__(self):
        ...
        timer_period = 0.02
        self.wheel_seperation = 1.00
        self.wheel_base = 1.4224
        ...
        # Store received cmd_vel message
        self.vel_msg = Twist()
        self.mode_selection = 4  # Default to 'none'
    

    def vel_callback(self, msg):
        self.vel_msg = msg
        # Here you could add logic to switch modes based on the received velocities
